...
class _LoginState extends State<Login> {
 ...
 login() async {
   final response = await http.post("http://haddad18.000webhostapp.com/pegawai/login.php",body: {
     "email": email, 
     "password": password
     });
...
class _RegisterState extends State<Register> {
 ...
 save() async {
   final response = await http.post("http://haddad18.000webhostapp.com/pegawai/register.php",
...
class _MainMenuState extends State<MainMenu> {
  ...
  Future<List> getData() async {
    final response = await http.get("http://haddad18.000webhostapp.com/pegawai/getPegawai.php");
